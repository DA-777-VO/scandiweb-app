...
export default function ProductCard({ product, onClick }) {
  ...
  const handleQuickShop = (e) => {
    e.stopPropagation();
    // Quick shop only works for in-stock products
  ...
  return (
    ...
    >
      <div className={styles.imageWrapper}>
        ...
        {/* Quick shop only shown for in-stock products on hover */}
        {product.inStock && (
          <button
